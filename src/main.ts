import { Plugin, TAbstractFile, TFolder, WorkspaceLeaf, normalizePath } from 'obsidian';
...
import { DEFAULT_SETTINGS, PlainTextSettingTab, PlainTextSettings } from './settings';
