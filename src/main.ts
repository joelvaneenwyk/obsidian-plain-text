import { Plugin, WorkspaceLeaf, TFolder, TAbstractFile, normalizePath } from "obsidian";
import { removeObsidianExtensions, removeOtherExtensions, craftLogMessage } from "./helper";
...
export default class PlaintextPlugin extends Plugin {
  ...
  createNewFile = async (file: TAbstractFile): Promise<void> => {
    ...
    new CreateNewPlaintextFileModal(this.app, "plaintext file.txt", async (res) => {
